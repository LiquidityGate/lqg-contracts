...
abstract contract LQGDAONodeTrustedSettings is LQGBase, LQGDAONodeTrustedSettingsInterface {
    ...
    modifier onlyDAONodeTrustedProposal() {
        ...
        if(getBool(keccak256(abi.encodePacked(settingNameSpace, "deployed")))) require(getContractAddress("lqgDAONodeTrustedProposals") == msg.sender, "Only DAO Node Trusted Proposals contract can update a setting");
        _;
    }
